...
<div style="display: flex; gap: 30px; align-items: flex-start; margin-bottom: 30px;">
  ...
  <div>
    ...
    <p><a href="/assets/docs/santos_cv.pdf">CV</a> · <a href="https://scholar.google.com/citations?hl=en&view_op=list_works&gmla=AJsN-F4BwdeO38yZHC33mdpHISKeeUWOM2MrP58Jmu_FqnGclT-PrKXGLTt31ViqNGXwOG3bMK1l3MdpQ2PGqrOE9tysBe43Ow&user=N0wlGBkAAAAJ">Google Scholar</a> · <a href="https://orcid.org/0000-0001-6856-3107">ORCID</a> · <a href="https://bsky.app/profile/lizmillermacroevo.bsky.social">Bluesky</a></p>
    <p>I got my love of deep-sea fishes from working in natural history collections throughout my career. My research aims to develop deep-sea fishes as a new model system for investigating processes of macroevolutionary diversification. Towards this end, our lab integrates systematics, phylogenetic comparative methods, morphometrics, data science and biogeography, all powered by museum collections.</p>
  </div>
</div>
...
<div style="display: flex; gap: 30px; align-items: flex-start; margin-bottom: 30px;">
  ...
  <div>
    ...
    <p><strong>Contact:</strong> kuznar.4 "at" osu.edu</p>
  </div>
</div>
...
<div style="display: flex; gap: 30px; align-items: flex-start; margin-bottom: 30px;">
  <img src="/assets/images/lab_headshots/huber.jpg" style="width: 200px; flex-shrink: 0;">
  <div>
